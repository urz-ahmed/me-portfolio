        ...
        <div className="container my-8 px-6 text-gray-600 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            <div className="w-6/12 md:w-3/12 mx-auto">
              <img src="https://media.licdn.com/dms/image/C5603AQHvo0D1uB5qxQ/profile-displayphoto-shrink_800_800/0/1664129379660?e=1689811200&v=beta&t=EmxmKAZpOx9yzKmjRRBzrqzxpV9OyOIN3hMhd2jlz8I" alt="image" loading="lazy" className='rounded-full' />
            </div>
